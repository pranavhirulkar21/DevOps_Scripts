...
$num = Read-Host "`n
1. To view the Owner of File/Folder.
2. To view Permissions of the File.
3. To Grant Specific Permissions to a User.
4. To Remove Specific Permissions from a User
5. To copy permission from one folder and give it to another.
6. To Change ownership of a File/Folder.
0. To Exit. `n"
